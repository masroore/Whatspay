...
if(!function_exists('multiFile')) {
    ...
    function multiFile($files = array())
    {
//dd($files[1]);
        $images=array();
...
//dd($img_name);
    ...
    $file_dimensions = array(
        'full'        => array('width' => 1600, 'height' => 1000, 'ext' => 'webp'),
        'large'    => array('width' => 1200, 'height' => 750,  'ext' => 'webp'),
        'medium'   => array('width' => 800,  'height' => 500,  'ext' => 'webp'),
        'full_jpeg' => array('width' => 800,  'height' => 500,  'ext' => 'jpg' ),
        'small'    => array('width' => 400,  'height' => 250,  'ext' => 'webp')
    );
