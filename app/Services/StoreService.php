...
class StoreService {
     ...
     * @var $userRepository
     */
    protected $storeRepository, $employeeRepository, $userRepository, $categoryRepository,$productRepository;
     ...
     * @param StoreRepositoryInterface $addressRepository
     */
...
//            dd($request['business_url']);
            ...
            $store_id = $store->id;
            if ($store->cash_on_delivery == 'enable'){
...
//            dd($stores);
    ...
    public function notificationview(Request $request){
       try{
              $data=Notification::
              where('notifiable_id',$request->store_id)
