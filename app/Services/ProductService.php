...
class ProductService {
     ...
     * @param ProductWithAttributeSetRepositoryInterface $productwithattributesetRepository
     * @param ProductAddOnsRepositoryInterface $productaddonsRepository
     * @param ProductsCustomFieldsRepositoryInterface $productscustomfieldsRepository
     * @param ProductLabelProductsRepositoryInterface $productlabelproductRepository
     * @param ProductTagsRepositoryInterface $producttagsRepository
     * @param ProductVariationsRepositoryInterface $productvariationsRepository
     * @param ProductVariationItemsRepositoryInterface $productvariationitemsRepository
     */
...
public $file_dimensions = array(

    'full'       => array('width' => 1600, 'height' => 1600, 'ext' => 'webp','key' => '-F','model' => 'Products' ),
    'large'          => array('width' => 1200, 'height' => 1200, 'ext' => 'webp','key' => '-L','model' => 'Products'),
    'medium'      => array('width' => 800,  'height' => 800,  'ext' => 'webp','key' => '-M','model' => 'Products'),
    'small'          => array('width' => 450,  'height' => 450,  'ext' => 'webp','key' => '-S','model' => 'Products'),
    'small-jpg'       => array('width' => 450,  'height' => 450,  'ext' => 'jpg','key' => '-SJ' ,'model' => 'Products'),
    'x-small'     => array('width' => 200,  'height' => 200,  'ext' => 'webp','key' => '-XS','model' => 'Products')
...
//            create unique Slug
            ...
            if($request['attributes'] && $request['attributes'][0]!= null){
            ...
            if($request['specifications'] && $request['specifications'][0]!= null ) {
...
//                        dd($specifications['title']);
            ...
            if($request['add_ons'] && $request['add_ons'][0]!= null ){
                // dd($request['add_ons']);
            ...
            if($request['labels'] && $request['labels'][0]!= null ){
            ...
            if($request['varients'] && $request['varients'][0]!= null ) {
                ...
                foreach ($request->varients as $key=>$varient) {
                    ...
                    // dd('ok');
                    if($varient['attribute'] && $varient['attribute'][0]!= null ) {
        ...
        return $product_parent->fresh('defaultProductAttributes',
...
//            $product = $this->productRepository->updateByColumn(['id' => $id], $request->input());
            ...
            $product_parent = $this->productRepository->updateGetModel(['id' => $id],
                [
                    'store_id'=>$request->store_id,
                    'brand_id'=>$request->brand_id,
                    'name'=>$request->name,
...
//                        dd($varient['attribute']);
    ...
    public function show($id) {
        ...
        return $product->fresh('defaultProductAttributes',
            'variations.productAttributes',
            'variations.product','comments');
    }
...
//        dd($request->all(),$attributeid,$product_id,$set_id);
        $varients=$this->productvariationsRepository
...
//dd($data);
    ...
    public function filterStores(Request $request)
    {
        try {
            $query= ProductTags::
              rightJoin('products','product_tags.product_id','=','products.id')
