...
//        protected $with=['variations','productAttributeSets','productLabels'];
    ...
    public function parentProduct() {
        return $this->belongsToMany(Products::class, 'product_variations', 'product_id', 'configurable_product_id');
    }
    ...
    public function variationAttributeSwatchesForProductList() {
        return $this
            ...
            ->join('product_variation_items', 'product_variation_items.variation_id', '=',
                'product_variations.id')
            ->join('product_attributes', 'product_attributes.id', '=', 'product_variation_items.attribute_id')
            ->join('product_attribute_sets', 'product_attribute_sets.id', '=',
